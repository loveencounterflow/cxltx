...
\immediate\write18{node "\CXLTXcliRoute" "\currfileabsdir" "\jobname" "," "helo" "readers (one)" > /tmp/temp.dat}\input{/tmp/temp.dat}

\exec{node "\CXLTXcliRoute" "\currfileabsdir" "\jobname" "," "helo" "readers (two)"}

\nodeRunScript{\CXLTXcliRoute}{\currfileabsdir}{\jobname}{,}{helo}{readers (three)}
